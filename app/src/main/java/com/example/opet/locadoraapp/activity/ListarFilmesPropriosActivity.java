...
public class ListarFilmesPropriosActivity extends Activity {
    ...
    public void carregarItems(){
        ...
        List<Filme> filmes = filmeDAO.carregarFilmesPorUsuario(MainActivity.loggedUser.getId());
        ...
        listaFilmes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent atualizarIntent = new Intent(ListarFilmesPropriosActivity.this, AtualizarFilmeActivity.class);
